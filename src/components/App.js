...
class App extends Component {
	...
	async loadBlockchainData() {
		...
		const daiTokenAddress = '0x64E5B6Ce7C9289cbd353bBB5a23f7419d4215477'; // Replace DAI Address Here from abis daitokenmock.json
					...
					<div className='row'>
						<main role='main' className='col-lg-12 d-flex text-center'>
							<div
								...
								style={{ width: '500px' }}>
								<img src={daiLogo} width='150' alt='logo' />
